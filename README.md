# convergio-longrunning

[![CI](https://github.com/Roberdan/convergio-longrunning/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-longrunning/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-longrunning/blob/main/LICENSE)
[![Rust](https://img.shields.io/badge/rust-stable-orange)](https://www.rust-lang.org/)
[![Zero Warnings](https://img.shields.io/badge/warnings-0-brightgreen)](#)

Long-running task manager — progress tracking, cancellation, heartbeat
...
```mermaid
graph LR
    CRATE[convergio-longrunning] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-longrunning = { git = "https://github.com/Roberdan/convergio-longrunning", tag = "v0.1.0" }
```
